...
class MyCallback extends MemStatisticsCallback;
  ...
  virtual function int instMemWrites();
    return tb_aida.i_dummy_imemory.cnt_wr;
  endfunction
  virtual function int instrMemReads();
    return tb_aida.i_dummy_imemory.cnt_rd;
  endfunction
  virtual function int dataMemWrites();
    return tb_aida.i_dummy_dmemory.cnt_wr;
  endfunction
  virtual function int dataMemReads();
    return tb_aida.i_dummy_dmemory.cnt_rd;
  endfunction
  virtual function int stackMemWrites();
    return tb_aida.i_dummy_stack_memory.cnt_wr;
  endfunction
  virtual function int stackMemReads();
    return tb_aida.i_dummy_stack_memory.cnt_rd;
  endfunction
